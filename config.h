...
static const char *fonts[]          = { "terminus:size=14:style=bold:antialias=true", "fontawesome:size=12:antialias=true" };
...
static Key keys[] = {
	...
	{ MODKEY,			            XK_F1,	   spawn,	       {.v = brightnessup} },
	...
	{ MODKEY|Mod4Mask,              XK_z,      incrgaps,       {.i = +5 } },
	{ MODKEY|Mod4Mask,              XK_x,      incrgaps,       {.i = -5 } },
